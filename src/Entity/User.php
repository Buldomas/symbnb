 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="Un autre utilisateur s'est déjà inscrit avec cette adresse."
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\NotBlank(message="Veuillez renseigner un votre prénom !")
     */
    private $firstName;
    ...
    // pas d'annotation ORM car pas dans la base
    /**
    ...
    //fonction obligatoire lié à l'implémentation de l'entité User avec gestion
    //des mots de passe crypté de l'interface UserInterface
    public function getRoles()
    {
        ...
        // récupère tous les rôles possibles pour le user dans le tablea $roles
        $roles[] = 'ROLE_USER';
        // renvoi le tableau
        return $roles;
    }
